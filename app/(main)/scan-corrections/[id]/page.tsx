...
import { useScanCorrectionDetail } from "@/hooks/useScanCorrections";
import { ArrowLeft, Loader2, User, Barcode, ImageOff } from "lucide-react";
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="rounded-xl bg-[#111111B2] border border-[#FFFFFF33] p-4">
                ...
                <dl className="space-y-2.5 font-sf-pro">
                  ...
                  <Field
                    label="Issue"
                    value={data.system_found.issue_number}
                  />
                  <Field
                    label="Publisher"
